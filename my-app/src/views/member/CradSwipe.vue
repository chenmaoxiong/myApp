...
export default {
	...
	data() {
		return {
			banner: [
				require("../../../public/img/vip_1.png"),
				require("../../../public/img/vip_2.png"),
				require("../../../public/img/vip_3.png"),
				require("../../../public/img/vip_4.png"),
				require("../../../public/img/vip_5.png"),
				require("../../../public/img/vip_6.png"),
				require("../../../public/img/vip_7.png")
			],
			i: 0
		};
	},
	created() {
		// var vm = this;
		// this.bus.$on("getI", this.wudi.bind(this));
		var vm = this;
		this.bus.$on("getI", data => {
			console.log(data);
			vm.i = data;
			// vm.mySwiper.slideTo(data);
		});
	},
	methods: {
		onClickLeft() {
	...
	beforeMount() {
		// console.log(1);
		// VueEvent.$on("cradswipe", function(data) {
		//     console.log(222);
		//     this.i = data;
		//     console.log(this.i);
		// });
